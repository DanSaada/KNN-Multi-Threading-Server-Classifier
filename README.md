...
- We have created a manual protocol for sending and reading messages from a socket, that is, the sender can inform the receiver of the message that this is the end of a message, this includes also informing about an error.
